...
const AdminEditFlight = ({ flights }) => {
    ...
    return <Fragment>
        ...
        {/* <!-- Modal --> */}
        <div class="modal fade" id={`id${flights.flight_id}`} tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" onClick={() => { setOrigin(flights.origin); setDestination(flights.destination); setAirline(flights.airline);}}>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Flight</h5>
                <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close" onClick={() => { setOrigin(flights.origin); setDestination(flights.destination); setAirline(flights.airline);}}>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal" onClick={() => { setOrigin(flights.origin); setDestination(flights.destination); setAirline(flights.airline);}}>Close</button>
